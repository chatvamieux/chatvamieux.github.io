...
BLOG_AUTHOR = "Iram"  # (translatable)
BLOG_TITLE = "Chat va mieux !"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://chatvamieux.fr/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://chatvamieux.fr/"
BLOG_EMAIL = "iram@example.com"
BLOG_DESCRIPTION = "Site (Non-officiel) de l'association Chatvamieux"  # (translatable)
